          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-10">
            ...
            <div className="flex gap-3">
              <Link
                ...
                className="bg-prussian/40 hover:bg-prussian/60 text-gray-300 font-medium py-2.5 px-5 rounded-lg transition-colors border border-prussian/50 flex items-center gap-2"
              >
                Newsletters
              </Link>
              <Link
